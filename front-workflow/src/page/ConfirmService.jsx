        ...
        <div style={{ display: 'flex', justifyContent: 'center' }}>
            {stars.map((star, index) => (
                <span key={index} onClick={() => handleClick(index)}>
                    <BsStarFill color={star < localRating ? "#41BCAC" : "#E5E7EB"} size={40} style={{ margin: '5px' }} />
                </span>
            ))}
        </div>
    );
        ...
        <>
            <section className="h-screen m-auto  max-w-xs  bg-white">
                ...
                <header className=" relative z-20 p-2">
                    ...
                    <h2 className="text-white text-xl font-semibold font-roboto p-2">
                ...
                <div className="relative mt-16 z-20 shadow-2xl rounded-lg p-2 m-6 bg-[#f0f0f0]">
                    ...
                    <div className="text-center pt-10">
                        <p className="text-[#242E42] text-sm font-semibold pb-4">Pablo Villafañe</p>
                        <h2 className="text-[#242E42] text-xl font-medium pb-1">Tec. En Electricidad</h2>
