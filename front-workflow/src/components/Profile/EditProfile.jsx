    ...
    <div className="h-screen flex justify-center items-start">
      <div className="bg-white p-4 rounded-lg w-80">
        <div className="flex items-center space-x-6 mb-[5rem] pt-10">
          <span onClick={handleBack} className="cursor-pointer text-[#41BCAC]">
            <FaArrowLeft />
          </span>
        ...
        <form>
          <div class=" bg-white text-xs ">
            <div class="flex items-center justify-between mb-3 bg-slate-100 ">
              ...
              <div class="relative">
                <select
                  class="bg-slate-100  appearance-none cursor-pointer rounded
            ...
            <div class="w-full p-1 bg-slate-50 ">
              ...
              <div class="flex items-center justify-between mb-1 bg-slate-100">
                ...
                <input
                  class="bg-slate-100 text-right  appearance-none  rounded
                                    py-2 px-3 text-gray-700 leading-tight focus:outline-none 
                                    focus:-outline "
                  id="email"
                  type="email"
              ...
              <div class="flex items-center justify-between mb-1 bg-slate-100">
                <label
                  class="text-gray-700 font-bold pl-2"
                  for="fechaNacimiento"
                >
                  Fecha de nacimiento
                </label>
