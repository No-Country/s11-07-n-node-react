        ...
        {isFormExpanded && (
          <form onSubmit={handleAddAddress}>
            ...
            <div>
              ...
              >
                <span className="text-[#41BCAC] ml-4 mr-4 text-xl">
                  <FaPlusCircle />
                </span>
                Agregar dirección
              </button>
            ...
            <ul
              className={`bg-slate-100 mt-4 text-black ${
                addresses.length >= 10 ? "overflow-auto max-h-[10rem]" : ""
              }`}
            >
