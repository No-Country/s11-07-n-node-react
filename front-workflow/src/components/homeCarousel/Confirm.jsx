        ...
        <>
            <section className="h-screen px-4 m-auto  max-w-xs  bg-white">
                ...
                <div className=" pt-[6vh]">
                    <h2 className="text-3xl text-center	text-black ">Confirme</h2>
                    <p className=" mt-8 text-center text-black w-72">Una enorme red de profesionales te ayudará con tus labores</p>
                </div>
            </section>
        </>
    );
