         ...
         <section className="hidden lg:block w-full">
            <div className="flex">
              <div className="w-[50%] relative">
                  <img src={bg} alt="" className="object-fill object-center w-full h-screen"/>
                  <img src={logob} alt="" className="absolute top-12 left-[42%] w-28" />
              </div>
              <div className="w-[50%] m-auto">
                <div className="w-full h-[70%] flex flex-col justify-center items-center">
                    <h1 className="text-center  text-3xl text-black font-bold mb-10">Inicia Seccion</h1>
                      ...
                      <form 
                        ...
                        >
                            ...
                            <label className="flex flex-col" >
                                <span className="text-black font-semibold">Contraseña</span>
                                <input 
                                type="password" 
                                {...register("password")}
                                autoComplete="off"
                            ...
                            <input className="bg-[#41BCAC] w-min m-auto text-white py-2 px-10 rounded-md cursor-pointer" type="submit" value="Iniciar sesión" />
                            <div className="text-center mt-4">
                              ...
                              <p>Sos nuevo? <span className="text-[#41BCAC] font-extrabold cursor-pointer">Registrate</span></p>
                            </div>
                        </form>
                        </div>
                        </div>
